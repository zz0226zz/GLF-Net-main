...
def plot_matrix(y_true, y_pred, labels_name, epoch, title=None, thresh=0.8, axis_labels=None):
    ...
    # 显示
    pl.savefig(f"evaluate_{epoch}.jpg", dpi=500, bbox_inches='tight')  # 解决图片不清晰，不完整的问题
    pl.tight_layout()
    pl.clf()
    # pl.show()
